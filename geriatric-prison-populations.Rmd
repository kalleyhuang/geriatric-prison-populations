...
one_year_population <- function(data) {
  ...
  # this would generate a vector of age groups to remove & we would have to somehow randomly 
  ...
  # this would sample 1 percent of population, which we could then remove
  # may not be particularly different from original sampling
  # sample_frac(population, 0.01, weight = population$odds_of_removal)

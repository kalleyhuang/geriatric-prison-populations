...
actual %>% 
  mutate(Under30 = AgeUnder20 + Age20to29, 
         Over60 = Age60to69 + Age70to79 + Age80to89 + Age90over) %>% 
  select(year, Under30, Over60) %>% 
  ggplot(data = ., mapping = aes(x = year, group = 1)) +
  geom_line(mapping = aes(y = Under30, color = "Under30")) +
  geom_line(mapping = aes(y = Over60, color = "Over60")) +
  labs(title = "Actual Number Under 30 & Over 60 Over Time", x = "Year", y = "Count") +
  scale_color_discrete(name = "Age Group",
...
ggplot(data = actual_long, mapping = aes(x = year, y = count, fill = age_group)) +
  geom_bar(position = "stack", stat = "identity") +
  labs(title = "Actual Age Groups Over Time", x = "Year", y = "Count") +
  scale_x_discrete(limits = c("1979", "1984", "1989", "1994", "1999", "2004", "2009", "2014", 
                              "2020")) +
  scale_fill_discrete(name = "Age Group",
                      breaks = c("AgeUnder20", "Age20to29", "Age30to39", "Age40to49", 
                                 "Age50to59", "Age60to69", "Age70to79", "Age80to89",
                                 "Age90over"),

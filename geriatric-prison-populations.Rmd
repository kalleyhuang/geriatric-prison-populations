...
one_year_population <- function(data) {
  ...
  # NOT TOTALLY FUNCTIONAL??? may have to change to sample_n()
  # also maybe: sample(x = c(AGE GROUPS), size = 0.01*nrow(population), replace = TRUE,
  #                   prob = c(ASSOCIATED MORTALITY RATES, ADJUSTED TO ADD TO 1.0))

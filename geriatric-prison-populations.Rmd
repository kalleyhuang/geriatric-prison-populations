...
one_year_population <- function(data) {
  ...
  over_90 <- sample_frac(over_90, (1 - 0.2000))
...
ggplot(data = no_parole_overall, mapping = aes(x = year, y = median_age)) +
  geom_line() +
  labs(title = "Median Age Over Time Without Parole", x = "Year", y = "Median Age") +
  theme_classic() +
...
no_parole_overall %>% 
  ...
  labs(title = "Percent Under 30 & Over 60 Over Time Without Parole", 
       x = "Year", y = "Percent") +
...
ggplot(data = no_parole_overall_long, mapping = aes(x = year, y = count, fill = age_group)) +
  ...
  labs(title = "Age Distribution Over Time Without Parole", x = "Year", y = "Count") +
...
simulation_base_alt <- no_parole_overall %>% 
  ...
  mutate(under_30 = (`19 - 29` + `< 18`) / total * 100, 
         over_60 = (`60 - 69` + `70 - 79` + `80 - 89` + `90 +`) / total * 100) %>% 
  select(total, median_age, under_30, over_60)
```
...
ggplot(data = parole_overall_long, mapping = aes(x = year, y = count, fill = age_group)) +
  geom_bar(position = "stack", stat = "identity") +
  labs(title = "Age Distribution Over Time With Parole", x = "Year", y = "Count") +
  scale_x_discrete(limits = c("1", "20", "40", "60", "80", "100")) +
  scale_fill_discrete(name = "Age Group",
                      breaks = c("< 18", "19 - 29", "30 - 39", "40 - 49", "50 - 59", "60 - 69",
                                 "70 - 79", "80 - 89", "90 +")) +
...
```{r policy_graphs}
ggplot(data = policy_overall, mapping = aes(x = year, y = median_age)) +
  geom_line() +
  labs(title = "Median Age Over Time if Parole is Eliminated", x = "Year", y = "Median Age") +
  theme_classic() +
  theme(plot.title = element_text(size = 15),
        axis.text.x = element_text(color = "#000000", size = 10),
        axis.text.y = element_text(color = "#000000", size = 10))
...
policy_overall %>% 
  ...
  geom_line(mapping = aes(y = under_30, color = "under_30")) +
  geom_line(mapping = aes(y = over_60, color = "over_60")) +
  labs(title = "Percent Under 30 & Over 60 if Parole is Eliminated", x = "Year", y = "Count") +
  scale_color_discrete(name = "Age Group",
                       breaks = c("under_30", "over_60"), labels = c("Under 30", "Over 60")) +
  theme_classic() +
  theme(plot.title = element_text(size = 15),
...
ggplot(data = policy_overall_long, mapping = aes(x = year, y = count, fill = age_group)) +
  geom_bar(position = "stack", stat = "identity") +
  labs(title = "Age Distribution Over Time if Parole is Eliminated", x = "Year", y = "Count") +
